...
for(const prefix of ['SHA256SUMS ',''])replace(prefix+'NativeHost.qml PairStore.js companion-notebook.qmd base.sha256 probe.sh | sort)',
  prefix+'NativeHost.qml PairStore.js companion-notebook.qmd base.sha256 probe.sh capture-frame | sort)');
...
replace('verify_prepared() {',`verify_disposable_preimages() {
    ...
    exact "$base/9baaab38-b382-4f8c-9871-2932c2afe4ca/eefe9ee2-0396-4688-b7f7-8328e186007d.rm" 53b159e7885d54de600519e5dd5d8cc033cc92d3c693122c6c0552721359f342 || return 1
    exact "$base/3ded6fc6-4f79-401e-99ec-dae6a934ae4a/59506a8a-b6fe-4d3c-8d91-acc427d5fac4.rm" 2c5fbc3ef4b77aa594fe00f8e2d9d7d355ee196ca0b2c92b3fdb6e0d9a989c44
}
verify_prepared() {
